...
psi_true = 10.*psi_true/int_tabulated(tpsi_true,psi_true)
...
save,psi_avg,file=string(form='("estimator_test.mjd.tlag.",I05,".sav")',long(tlag))
prepare_plots,/color
